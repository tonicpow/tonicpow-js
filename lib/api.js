...
async function convertGoalByID (t, goalId, tncpwSession, additionalData = '') {
  let data = { id: goalId, tncpw_session: tncpwSession, additional_data: additionalData }
  return tonicAxios.post(t.config.apiUrl + version + '/goals/convert', data, getOptions())
}
...
async function convertGoalByName (t, goalName, tncpwSession, additionalData = '') {
  let data = { name: goalName, tncpw_session: tncpwSession, additional_data: additionalData }
  return tonicAxios.post(t.config.apiUrl + version + '/goals/convert', data, getOptions())
}
...
async function convertGoalByUserID (t, goalId, userId, additionalData = '') {
  let data = { id: goalId, user_id: userId, additional_data: additionalData }
  return tonicAxios.post(t.config.apiUrl + version + '/goals/convert', data, getOptions())
}
...
module.exports = {
  ...
  convertGoalByID: async function (goalId, tncpwSession, additionalData = '') {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await convertGoalByID(this, goalId, tncpwSession, additionalData)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
  ...
  convertGoalByName: async function (goalName, tncpwSession, additionalData = '') {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await convertGoalByName(this, goalName, tncpwSession, additionalData)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
  ...
  convertGoalByUserID: async function (goalId, userId, additionalData = '') {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await convertGoalByUserID(this, goalId, userId, additionalData)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
