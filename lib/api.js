...
async function resendEmailVerification (t, userId, userSessionToken = '') {
  return tonicAxios.post(t.config.apiUrl + version + '/users/verify/email/send', { id: userId }, getOptions(userSessionToken))
}
...
async function resendPhoneVerification (t, userId, userSessionToken = '') {
  return tonicAxios.post(t.config.apiUrl + version + '/users/verify/phone/send', { id: userId }, getOptions(userSessionToken))
}
...
module.exports = {
  ...
  resendEmailVerification: async function (userId, userSessionToken = '') {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await resendEmailVerification(this, userId, userSessionToken)
  ...
  resendPhoneVerification: async function (userId, userSessionToken = '') {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await resendPhoneVerification(this, userId, userSessionToken)
        resolve({ success: 'verification sent' })
      } catch (e) {
        reject(checkError(e))
      }
