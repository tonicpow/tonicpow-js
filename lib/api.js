...
async function acceptUser (t, userId) {
  return tonicAxios.put(t.config.apiUrl + apiVersion + '/users/status/accept', { id: userId }, getOptions())
}
...
async function activateUser (t, userId) {
  return tonicAxios.put(t.config.apiUrl + apiVersion + '/users/status/activate', { id: userId }, getOptions())
}
...
async function pauseUser (t, userId, reason) {
  return tonicAxios.put(t.config.apiUrl + apiVersion + '/users/status/pause', { id: userId, reason: reason }, getOptions())
}
...
async function listCampaignsByAdvertiserProfile (t, profileId, page = 1, resultsPerPage = 20) {
  return tonicAxios.get(t.config.apiUrl + apiVersion + '/advertisers/campaigns/' + profileId + '?current_page=' + page + '&results_per_page=' + resultsPerPage, getOptions())
}
...
async function listCampaigns (t, customSessionToken = '', page = 1, resultsPerPage = 20) {
  return tonicAxios.get(t.config.apiUrl + apiVersion + '/campaigns/list?current_page=' + page + '&results_per_page=' + resultsPerPage, getOptions(customSessionToken))
}
...
async function listCampaignsByUrl (t, url, page = 1, resultsPerPage = 20) {
  return tonicAxios.get(t.config.apiUrl + apiVersion + '/campaigns/find?target_url=' + url + '&current_page=' + page + '&results_per_page=' + resultsPerPage, getOptions())
}
...
module.exports = {
  ...
  acceptUser: async function (userId) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await acceptUser(this, userId)
  ...
  activateUser: async function (userId) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await activateUser(this, userId)
  ...
  pauseUser: async function (userId, reason) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await pauseUser(this, userId, reason)
  ...
  listCampaignsByAdvertiserProfile: async function (profileId, page = 1, resultsPerPage = 20) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await listCampaignsByAdvertiserProfile(this, profileId, page, resultsPerPage)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
  ...
  listCampaigns: async function (customSessionToken = '', page = 1, resultsPerPage = 20) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        // this.session.userToken = customSessionToken (can't assume its a user)
        // setUserToken(this, userSessionToken)
        let response = await listCampaigns(this, customSessionToken, page, resultsPerPage)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
  ...
  listCampaignsByUrl: async function (url, page = 1, resultsPerPage = 20) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await listCampaignsByUrl(this, url, page, resultsPerPage)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
