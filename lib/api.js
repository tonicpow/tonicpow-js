...
async function resendEmailVerification (t, userId) {
  return tonicAxios.post(t.config.apiUrl + version + '/users/verify/email/send', { id: userId }, getOptions())
}
...
async function resendPhoneVerification (t, userId) {
  return tonicAxios.post(t.config.apiUrl + version + '/users/verify/phone/send', { id: userId }, getOptions())
}
...
async function getCurrentRate (t, currency) {
  return tonicAxios.get(t.config.apiUrl + version + '/rates/' + currency, getOptions())
}
...
module.exports = {
  ...
  resendEmailVerification: async function (userId) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await resendEmailVerification(this, userId)
  ...
  resendPhoneVerification: async function (userId) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        await resendPhoneVerification(this, userId)
        resolve({ success: 'verification sent' })
      } catch (e) {
        reject(checkError(e))
      }
  ...
  getCurrentRate: async function (currency) {
    return new Promise(async (resolve, reject) => {
      try {
        initCheck(this.loaded)
        let response = await getCurrentRate(this, currency)
        resolve(response.data)
      } catch (e) {
        reject(checkError(e))
      }
